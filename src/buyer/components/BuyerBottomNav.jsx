...
const BuyerBottomNav = () => {
  ...
  const moreNavItems = [
    { label: "Find Farmers", to: "/buyer/find-farmers", icon: <SearchIcon /> },
    { label: "Recent Farmers", to: "/buyer/recent-farmers", icon: <HistoryIcon /> },
    { label: "Add New Farmer", to: "/buyer/register-farmer", icon: <PersonAddIcon /> },
    { label: "History", to: "/buyer/transactions", icon: <HistoryIcon /> },
  ];
